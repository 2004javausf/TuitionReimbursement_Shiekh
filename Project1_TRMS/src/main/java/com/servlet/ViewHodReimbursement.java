...
/**
 * Servlet implementation class ViewHodReimbursement
 */
public class ViewHodReimbursement extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String vgJSON;
		try {
			vgJSON=mapper.writeValueAsString(vgdi.getHODReimbursementList(id));
